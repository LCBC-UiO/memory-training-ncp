...
if(params$rerun_bootstrap){
  ...
  bootgrid <- future_map_dfr(seq_len(nresamp), function(i){
    ...
    response <- "hwt_z"
    upmod <- update(mod, data = boot_sampfun(mod, memdat_long, "hwt_z", TRUE))
    grids$grid %>%
      mutate(
